...
<html lang="en">
	<head>
	    ...
	    <title>Dreamy-Design Home Page</title>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Paints</a></li>
					<li><a href="#furniture" data-toggle="tab">Frames</a></li>
					<li><a href="#furniture" data-toggle="tab">Crafts</a></li>
